...
CYLS    EQU     20              ; 磁盘读到哪个柱面

        ORG     0x7c00          ; 告诉编译器，程序在内存中的哪里，后面取地址时编译器会加上该偏移量
                                ; 不然会取错地址
...
; 这里共读了20个柱面,2面磁头,18个扇区-1扇区(启动区)的数据进内存, 20×2×18×512-512=368640Byte-512Byte=360KB-512Byte
; 写入了内存0x08200～0x62000
