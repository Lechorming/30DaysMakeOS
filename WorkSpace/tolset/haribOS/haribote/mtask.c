...
/* 初始化任务管理，同时把调用该函数的任务和兜底的中断任务加入到任务队列中，返回调用该函数的task所在的内存地址 */
struct TASK *task_init(struct MEMMAN *memman)
{
    int i;
    struct TASK *task, *idle; /* task是调用该函数的任务，idle是兜底的中断任务 */
